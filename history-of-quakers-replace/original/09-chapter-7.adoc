...
8:4+++.+++ The which doth now evidently appear, and their folly is made manifest unto all,
...
the Holy Spirit, so their recovery was only by it.__--Jos.
Wyeth`'s__ [.book-title]#"`Anguis Flagel.`"#]
...
where he wrote the book called [.book-title]#The Moderate Enquirer
