...
But now you force me, that ex officio^
...
nor three anythings else besides subsistences.
Ergo, they are three subsistences.
...
William Penn published a book with the title, The Sandy Foundation Shaken,
...
dangerous practices of seditious sectaries and other disloyal persons,
who under pretense of tender consciences,
have or may at their meetings contrive insurrections (as late experience has shown):
...
a fine of five shillings for their first offense:
...
then such offender shall for every such offense incur the penalty of ten shillings;
...
shall forfeit for his first offense the sum of twenty pounds,
...
then such offender shall for every such offense, incur the penalty of forty pounds,
...
and be convicted thereof in manner aforesaid, shall forfeit the sum of twenty pounds,
...
G+++.+++ Fox told him, "`according to, does not mean the very same thing.
