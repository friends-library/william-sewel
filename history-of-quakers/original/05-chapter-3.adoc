...
undertook to translate that denomination into Dutch, _Gespitste huyzen,_
it gave occasion to some Latin writers in Germany, to complain,
that the Quakers scornfully called their temples __Domus acuminatas.__^
footnote:[Steeple-house.]
And though Croese says also in _Historia Quakeriana_ concerning them,
// lint-disable invalid-characters "æ"
__Templa cuncti Quakeri contumeliosè vocabant æedes pyramidatas,__^
...
// lint-disable invalid-characters "æ"
__Duris ut ilex tonsa pipennibus, per damna, per cædes, ab ipso,
